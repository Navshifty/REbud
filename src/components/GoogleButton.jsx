...
/*
  ...
  Visual only for now — real OAuth is wired in a later phase.
*/
export default function GoogleButton({ onClick, label = "Continue with Google" }) {
  return (
    <button
      type="button"
      onClick={onClick}
      className="w-full flex items-center justify-center gap-2.5 px-4 py-2.5 border text-[13.5px]"
      style={{ borderColor: T.line, color: T.black, ...sans }}
    >
      <svg width="16" height="16" viewBox="0 0 48 48" aria-hidden="true">
        ...
        <path fill="#4CAF50" d="M24 44c5.4 0 10.3-1.9 14-5.4l-6.5-5.4C29.5 34.9 26.9 36 24 36c-5.4 0-9.9-3.1-11.5-7.6l-6.5 5C9.5 39.6 16.2 44 24 44z"/>
        <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.2 4.2-4.1 5.6l6.5 5.4C41 36.5 44 30.9 44 24c0-1.3-.1-2.7-.4-3.5z"/>
      </svg>
      {label}
    </button>
  );
